...
import logo from '../loadingLogoPMS/logo2.svg'
import './loadingLogoReport.scss'

function LoadingLogoReport2() {
    return (
        <div className='content-loading22'>
...
export default LoadingLogoReport2